...
class _ScheduleSelectRideScreenState extends State<ScheduleSelectRideScreen> {
  ...
  Future<void> _scheduleTrip() async {
    ...
    if (_selectedRide != null && _selectedPaymentMode != null) {
      final selectedRide = rideServiceController.fareAmounts.firstWhere((request) => request.rideCategoryName == _selectedRide);
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: AppTextStyles.text14Black400.copyWith(color: searchtextGrey),
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        'Cash',
                                        style: AppTextStyles.text14Black500.copyWith(color: formTextLabelColor, fontSize: 10.0),
                                      ),
                                    ],
                                  ),
                                ),
