            ...
            SliverOverlapAbsorber(
              ...
              sliver: SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: Padding(
                    padding: const EdgeInsets.only(top: 100.0, left: 16, bottom: 8, right: 16),
                    child: Column(
                          ...
                          return Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                IconButton(
                                  icon: const Icon(Icons.drag_handle, color: disabledButtonGrey),
              ...
              slivers: [
                ...
                SliverList(
                  delegate: SliverChildBuilderDelegate(
                    ...
                    childCount: MyData.destinations.length,
                  ),
                ),
              ],
            );
