...
class MyData{
  ...
  static List<RideRequest> requests = [
    RideRequest(ridetype: 'Economy', timeEstimate: '1 min away', imageUrl: 'assets/images/economy.png', discountedPrice: 460, originalprice: 580),
    RideRequest(ridetype: 'Boda', timeEstimate: '3 min away', imageUrl: 'assets/images/boda.png', discountedPrice: 180, originalprice: 220),
    RideRequest(ridetype: 'Taxi Comfort', timeEstimate: '5 min away', imageUrl: 'assets/images/economy.png', discountedPrice: 660, originalprice: 720),
  ];
}